...
2. Launch ImageForge Optimiser.
3. Drag images or folders into the application.
4. Select your preferred format and quality settings.
5. Click **Optimise Images**.
6. Optimised files will be saved automatically.
